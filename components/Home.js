...
// import "./Home.css"; // We'll create this separate CSS file as well
...
//           <Link to="/add-memory" className="cta-button">Start Adding Memories</Link>
//           <Link to="/query-memories" className="cta-button secondary">Query Existing Memories</Link>
//         </div>
//       </div>
...
//             <h4>Add Memories</h4>
//             <p>Record important memories, events, and relationships</p>
//           </div>
          
//           <div className="step">
//             <div className="step-number">2</div>
//             <h4>AI Processing</h4>
//             <p>Our AI organizes and connects memories for natural recall</p>
//           </div>
...
//           <p>"MemoryVault has been life-changing for our family. Mom can now access memories we thought were lost forever."</p>
//           <p className="testimonial-author">- Sarah K., Family Member</p>
//         </div>
//       </div>
//     </div>
//   );
